...
perceptual develop ops (DR-compression + ASC-CDL ColorGrade + OKLCh HSL — all
shipped) can push pixels outside AP1, which present here as **negative AP1
channels**; RGC rolls
