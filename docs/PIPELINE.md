...
perceptual develop ops (DR-compression + ASC-CDL ColorGrade — shipped; OKLCh
HSL — coming) can push pixels outside AP1, which present here as **negative AP1
channels**; RGC rolls
